...
B<TODO:> include some examples (catch error in C<Alive> (not implemented yet), test in C<Primary>).
...
with the help of the C<Test::PostgreSQL::SecureMonitoring> module.
