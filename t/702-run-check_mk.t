...
is $data->{check_mk_data}[0][2][0][0], "activity__total",                         "Column total";
is $data->{check_mk_data}[0][2][1][0], "activity__active",                        "Column active";
is $data->{check_mk_data}[0][2][2][0], "activity__idle",                          "Column idle";
is $data->{check_mk_data}[0][2][3][0], "activity__idle_in_transaction",           "Column idle in transaction";
is $data->{check_mk_data}[0][2][4][0], "activity__idle_in_transaction__aborted_", "Column idle in transaction (aborted)";
is $data->{check_mk_data}[0][2][5][0], "activity__fastpath_function_call",        "Column fastpath function call";
is $data->{check_mk_data}[0][2][6][0], "activity__disabled",                      "Column disbled";
