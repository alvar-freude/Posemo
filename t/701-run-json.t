...
ok !-f "$dir/t-211-simple.json", "result file does NOT exist";
...
ok -f "$dir/t-211-simple.json", "result file exists";

my $json = io("$dir/t-211-simple.json")->all;
